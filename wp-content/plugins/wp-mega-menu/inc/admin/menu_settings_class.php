        ...
        function apmm_settings_table($location, $menu_general_settings ){
          ...
          // exit();
           ?>
              ...
              <table>
                      <tr>
                      <td><label for="apmegamenu_enabled"><?php _e("Enable", APMM_TD) ?></label></td>
                          <td> 
                           <div class="wpmm-switch">
                              <input type='checkbox' class='apmegamenu_enabled' 
                              name='apmegamenu_meta[<?php echo $location ?>][enabled]' id="apmegamenu_enabled" value='1' <?php checked( isset( $menu_general_settings[$location]['enabled'] ) ); ?>/>
                             <label for="apmegamenu_enabled"></label>
                           </div>
                          </td>
                       </tr>
                      ...
                      class="select_fields_wpmm">
                          <?php
                              ...
                              foreach ( $themes as $key => $theme ) {
                                ...
                                echo "<option value='{$theme_id}' " . selected( $selected_theme, $key ) . ">{$theme_title}</option>";
                              }
                          ?>
                      </select>
                  </td>
